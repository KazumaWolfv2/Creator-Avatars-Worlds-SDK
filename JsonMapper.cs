...
namespace LitJson
{
	...
	{
		// Token: 0x0600014A RID: 330 RVA: 0x000067A0 File Offset: 0x000049A0
		static JsonMapper()
		{
		...
		// Token: 0x0600014B RID: 331 RVA: 0x00006854 File Offset: 0x00004A54
		...
		// Token: 0x0600014C RID: 332 RVA: 0x0000694C File Offset: 0x00004B4C
		...
		// Token: 0x0600014D RID: 333 RVA: 0x00006AD8 File Offset: 0x00004CD8
		...
		// Token: 0x0600014E RID: 334 RVA: 0x00006BD0 File Offset: 0x00004DD0
		...
		// Token: 0x0600014F RID: 335 RVA: 0x00006CC0 File Offset: 0x00004EC0
		private static object ReadValue(Type inst_type, JsonReader reader)
		{
			...
			else
			{
				...
				{
					return JsonMapper.custom_importers_table[type3][type](reader.Value);
				}
				if (JsonMapper.base_importers_table.ContainsKey(type3) && JsonMapper.base_importers_table[type3].ContainsKey(type))
				{
					return JsonMapper.base_importers_table[type3][type](reader.Value);
				}
				if (type.IsEnum)
				{
		...
		// Token: 0x06000150 RID: 336 RVA: 0x00007050 File Offset: 0x00005250
		...
		// Token: 0x06000151 RID: 337 RVA: 0x00007179 File Offset: 0x00005379
		private static void ReadSkip(JsonReader reader)
		{
			JsonMapper.ToWrapper(() => new JsonMockWrapper(), reader);
		}

		// Token: 0x06000152 RID: 338 RVA: 0x000071A4 File Offset: 0x000053A4
		...
		// Token: 0x06000153 RID: 339 RVA: 0x000073B0 File Offset: 0x000055B0
		private static void RegisterBaseImporters()
		{
			...
			importerFunc = (object input) => Convert.ToSingle((double)input);
			...
			importerFunc = (object input) => DateTimeOffset.Parse((string)input, JsonMapper.datetime_format);
			JsonMapper.RegisterImporter(JsonMapper.base_importers_table, typeof(string), typeof(DateTimeOffset), importerFunc);
		}

		// Token: 0x06000154 RID: 340 RVA: 0x0000776E File Offset: 0x0000596E
		...
		// Token: 0x06000155 RID: 341 RVA: 0x00007794 File Offset: 0x00005994
			...
			else
			{
				...
				if (dictionary != null)
				{
					...
					foreach (object obj4 in dictionary)
					{
						...
						string text2 = ((text != null) ? text : Convert.ToString(dictionaryEntry.Key, CultureInfo.InvariantCulture));
		...
		// Token: 0x06000156 RID: 342 RVA: 0x00007BE0 File Offset: 0x00005DE0
		...
		// Token: 0x06000157 RID: 343 RVA: 0x00007C3C File Offset: 0x00005E3C
		public static void ToJson(object obj, JsonWriter writer)
		{
			JsonMapper.WriteValue(obj, writer, false, 0);
		}

		// Token: 0x06000158 RID: 344 RVA: 0x00007C47 File Offset: 0x00005E47
		public static JsonData ToObject(JsonReader reader)
		{
			return (JsonData)JsonMapper.ToWrapper(() => new JsonData(), reader);
		}

		// Token: 0x06000159 RID: 345 RVA: 0x00007C74 File Offset: 0x00005E74
		...
		// Token: 0x0600015A RID: 346 RVA: 0x00007CB2 File Offset: 0x00005EB2
		public static JsonData ToObject(string json)
		{
			return (JsonData)JsonMapper.ToWrapper(() => new JsonData(), json);
		}

		// Token: 0x0600015B RID: 347 RVA: 0x00007CDE File Offset: 0x00005EDE
		public static T ToObject<T>(JsonReader reader)
		{
			return (T)((object)JsonMapper.ReadValue(typeof(T), reader));
		}

		// Token: 0x0600015C RID: 348 RVA: 0x00007CF8 File Offset: 0x00005EF8
		...
		// Token: 0x0600015D RID: 349 RVA: 0x00007D24 File Offset: 0x00005F24
		...
		// Token: 0x0600015E RID: 350 RVA: 0x00007D50 File Offset: 0x00005F50
		public static object ToObject(string json, Type ConvertType)
		{
			JsonReader jsonReader = new JsonReader(json);
			return JsonMapper.ReadValue(ConvertType, jsonReader);
		}

		// Token: 0x0600015F RID: 351 RVA: 0x00007D6B File Offset: 0x00005F6B
		public static IJsonWrapper ToWrapper(WrapperFactory factory, JsonReader reader)
		{
			return JsonMapper.ReadValue(factory, reader);
		}

		// Token: 0x06000160 RID: 352 RVA: 0x00007D74 File Offset: 0x00005F74
		...
		// Token: 0x06000161 RID: 353 RVA: 0x00007D90 File Offset: 0x00005F90
		...
		// Token: 0x06000162 RID: 354 RVA: 0x00007DCC File Offset: 0x00005FCC
		...
		// Token: 0x06000163 RID: 355 RVA: 0x00007E10 File Offset: 0x00006010
		public static void UnregisterExporters()
		{
			JsonMapper.custom_exporters_table.Clear();
		}

		// Token: 0x06000164 RID: 356 RVA: 0x00007E1C File Offset: 0x0000601C
		...
		private static readonly int max_nesting_depth = 100;

		// Token: 0x040001AE RID: 430
		private static readonly IFormatProvider datetime_format = DateTimeFormatInfo.InvariantInfo;

		// Token: 0x040001AF RID: 431
		private static readonly IDictionary<Type, ExporterFunc> base_exporters_table = new Dictionary<Type, ExporterFunc>();

		// Token: 0x040001B0 RID: 432
		private static readonly IDictionary<Type, ExporterFunc> custom_exporters_table = new Dictionary<Type, ExporterFunc>();

		// Token: 0x040001B1 RID: 433
		private static readonly IDictionary<Type, IDictionary<Type, ImporterFunc>> base_importers_table = new Dictionary<Type, IDictionary<Type, ImporterFunc>>();

		// Token: 0x040001B2 RID: 434
		private static readonly IDictionary<Type, IDictionary<Type, ImporterFunc>> custom_importers_table = new Dictionary<Type, IDictionary<Type, ImporterFunc>>();

		// Token: 0x040001B3 RID: 435
		private static readonly IDictionary<Type, ArrayMetadata> array_metadata = new Dictionary<Type, ArrayMetadata>();

		// Token: 0x040001B4 RID: 436
		private static readonly object array_metadata_lock = new object();

		// Token: 0x040001B5 RID: 437
		private static readonly IDictionary<Type, IDictionary<Type, MethodInfo>> conv_ops = new Dictionary<Type, IDictionary<Type, MethodInfo>>();

		// Token: 0x040001B6 RID: 438
		private static readonly object conv_ops_lock = new object();

		// Token: 0x040001B7 RID: 439
		private static readonly IDictionary<Type, ObjectMetadata> object_metadata = new Dictionary<Type, ObjectMetadata>();

		// Token: 0x040001B8 RID: 440
		private static readonly object object_metadata_lock = new object();

		// Token: 0x040001B9 RID: 441
		private static readonly IDictionary<Type, IList<PropertyMetadata>> type_properties = new Dictionary<Type, IList<PropertyMetadata>>();

		// Token: 0x040001BA RID: 442
		private static readonly object type_properties_lock = new object();

		// Token: 0x040001BB RID: 443
		private static readonly JsonWriter static_writer = new JsonWriter();
